<template>
    <div class="body">
        ...
        <div class="error">
            ...
            <div style="margin-top:50px;"> More Templates <a href="http://www.cssmoban.com/" target="_blank"
...
export default defineComponent({
    setup() {
        let html = `<el-button>测试</el-button>`;

        let cordCanvas: any = null;
        let ctx: any = null;
        ...
        let methods = {
            ...
            animate() {
                ...
                window.requestAnimationFrame(methods.animate);
