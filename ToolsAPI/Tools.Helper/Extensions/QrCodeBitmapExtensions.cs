...
namespace Tools.Helper.Extensions
{
    /// <summary>
    ...
    public static class QrCodeBitmapExtensions
    {
        ...
        public static Bitmap ToBitmap(this QrCode qrCode, int scale, int border, System.Drawing.Color foreground, System.Drawing.Color background)
        {
            // check arguments
            if (scale <= 0)
            {
        ...
        {
            return qrCode.ToBitmap(scale, border, System.Drawing.Color.Black, System.Drawing.Color.White);
        }
        ...
        {
            Draw(qrCode, graphics, scale, border, System.Drawing.Color.Black, System.Drawing.Color.White);
        }

        /// <inheritdoc cref="Draw(QrCode, Graphics, float, float)"/>
        /// <param name="background">The background color.</param>
        /// <param name="foreground">The foreground color.</param>
        public static void Draw(this QrCode qrCode, Graphics graphics, float scale, float border, System.Drawing.Color foreground, System.Drawing.Color background)
        {
            if (scale <= 0 || border < 0)
            {
                return;
        ...
        /// <param name="background">The background color.</param>
        /// <param name="foreground">The foreground color.</param>
        public static byte[] ToPng(this QrCode qrCode, int scale, int border, System.Drawing.Color foreground, System.Drawing.Color background)
        {
        ...
        {
            return qrCode.ToPng(scale, border, System.Drawing.Color.Black, System.Drawing.Color.White);
        }

        /// <inheritdoc cref="SaveAsPng(QrCode, string, int, int)"/>
        /// <param name="background">The background color.</param>
        /// <param name="foreground">The foreground color.</param>
        public static void SaveAsPng(this QrCode qrCode, string filename, int scale, int border, System.Drawing.Color foreground, System.Drawing.Color background)
        {
            using Bitmap bitmap = qrCode.ToBitmap(scale, border, foreground, background);
        ...
        {
            qrCode.SaveAsPng(filename, scale, border, System.Drawing.Color.Black, System.Drawing.Color.White);
        }
    }
}
